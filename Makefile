...
PACKAGE ?= helm-authentik
XRD_DIR := apis/authentiks
COMPOSITION := $(XRD_DIR)/composition.yaml
DEFINITION := $(XRD_DIR)/definition.yaml
EXAMPLE_DEFAULT := examples/authentiks/standard.yaml
...
EXAMPLES := \
    examples/authentiks/minimal.yaml:: \
    examples/authentiks/standard.yaml::
...
render\:%:
	@example="examples/authentiks/$*.yaml"; \
	up composition render --xrd=$(DEFINITION) $(COMPOSITION) $$example
